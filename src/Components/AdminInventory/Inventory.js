...
const Inventory = () => {
  ...
  const handleSortAZ = () => {
    const sorted = [...filteredData].sort((a, b) => a.product_name.localeCompare(b.product_name));
    setFilteredData(sorted);
  };

  const handleSortZA = () => {
    const sorted = [...filteredData].sort((a, b) => b.product_name.localeCompare(a.product_name));
    setFilteredData(sorted);
  };

  const handleSortLowToHigh = () => {
    const sorted = [...filteredData].sort((a, b) => parseFloat(a.price) - parseFloat(b.price));
    setFilteredData(sorted);
  };

  const handleSortHighToLow = () => {
    const sorted = [...filteredData].sort((a, b) => parseFloat(b.price) - parseFloat(a.price));
    setFilteredData(sorted);
  };
